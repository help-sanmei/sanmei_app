module ApplicationHelper
  ...
  def meishiki_data_create(birthday,gender,id)
 
  logger.debug("======================= birthday = #{birthday}")
  logger.debug("======================= gender = #{gender}")
  logger.debug("======================= staff.id = #{id}")
  ...
  # 計算ボタンイベント
        ...
        this_day = Date.today.day
          ...
          #計算
        b_y_inp=birthday.year.to_i
        b_y0=b_y_inp
        b_m0=birthday.month.to_i
        b_d0=birthday.day.to_i
      ...
      logger.debug("im_kd = #{im_kd} ,im_km = #{im_km},im_ky=#{im_ky},im_sd = #{im_sd},im_sm = #{im_sm},im_sy = #{im_sy},im_tx = #{im_tx}")
    ...
    # end
      ...
      #月干と大運干支
        ...
        bg_flag=1
      #年干と大運干支
      elsif  calc_isoho3(im_ky,im_sy,taiun_kan,taiun_shi)=="大半会" || calc_isoho3(im_ky,im_sy,taiun_kan,taiun_shi)=="天剋" || calc_isoho3(im_ky,im_sy,taiun_kan,taiun_shi)=="納音" || calc_isoho3(im_ky,im_sy,taiun_kan,taiun_shi)=="��音" || calc_isoho3(im_ky,im_sy,taiun_kan,taiun_shi)=="天剋・刑"
        bg_flag=1
      end
      ...
      nen_tx = 0
      nen_tx=11-cint((im_py-1)/10)*2 #年干支から算出した宿命天中殺��支
      ...
      staff.update(im_kd: im_kd, im_km: im_km, im_ky: im_ky, im_sd: im_sd, im_sm: im_sm, im_sy: im_sy, im_tx: im_tx,
                    ym_sn: ym_sn, ym_jy: ym_jy, ym_sw: ym_sw, ym_sc: ym_sc, ym_se: ym_se, ym_jd: ym_jd, ym_ss: ym_ss, ym_jm: ym_jm,
                    moku: moku, ka: ka, dou: dou, gon: gon, sui: sui, energy_1: energy_sum2[1],energy_2: energy_sum2[2],energy_3: energy_sum2[3],energy_4: energy_sum2[4],energy_5: energy_sum2[5])
   
  
  logger.debug("=============================================maishiki_data_create end")


  end # def maishiki_data_create
